...
| [A1b-acid-mechanisms](cards/A1b-acid-mechanisms.md) | A | P1 | workstation | blocked: A1g | bridge-side H3O+ / neutral attacker |
...
**Done** (acceptance verified on main): A1f-acid-neutral-water-attacker-relay,
