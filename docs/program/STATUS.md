...
- 2026-09-06 16:00 PDT — (hermes-custom-build-001; profile=workstation) — A3 BLOCKED on READY A3g after the independently verified neutral 500s Al-OH-Al n=2 attempt failed before production science. HF/STO-3G advisory preoptimization spent 100 steps and ended with H52 ambiguous between O15/O9 at `1.134/1.195 A`; the raw endpoint is absent, so this is neither a completed proton-transfer nor production no-basin claim. Final adversarial review also closed stale approach/product reuse, coordinate-level frozen-shell drift, lookalike Store provenance, bool/route false-greens, and complete Oaa n=2/4/6 center coverage. Fresh CPU-only QA: 672 passed plus whole-QM Ruff/format/diff green. A3g owns one finite zero-retry H52-O15-constrained → released B3LYP test with durable endpoints and independent verification; identical replay and n=4/6 remain prohibited.
