...
- 2026-09-06 14:02 PDT — (hermes-custom-build-001; profile=workstation) — A3 ACTIVE on the independently gated neutral 500s Al-OH-Al family. Pre-launch adversarial review blocked unsafe DFT and the hardening pass now defines exact non-aliased Oaa rungs/centers n=2/4/6 at 18/23/18, makes the terminal receipt the final durable commit point, validates the SQLite evidence graph read-only, binds/quarantines TS guesses to the optimized reactant and settings, and enforces quick-IRC atom/state/shell plus structural bridge-H identity. Physical dry-runs produce exact neutral 55/68/81-atom cells with 17/25/33 frozen atoms; odd n=1 rejects. A second cold review's four residual blockers are regression-closed: transitive stale-saddle reuse, self-consistent wrong-tier stores, remote substrate-proton transfer, and signal interruption at terminal commit. Full CPU-only QA: 656 passed plus whole-QM Ruff/format/diff green. No DFT result is claimed yet.
