...
SCHEMA = "d2c-sct-campaign-preflight-v7"
...
def _validate_production_boundary(
    ...
    """Rebind a persisted run to the independently trusted scientific inputs."""
...
def create_preflight_receipt(
    ...
    *,
    ...
    Git/dependency identity inputs are injectable to keep unit tests free of live
    Git and GPU discovery. Normal CLI use always resolves both identity inputs.
